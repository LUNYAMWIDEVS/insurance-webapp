...
export const CREATE_INDUSTRIAL_ALL_RISKS=gql`
mutation createMoney (
    ...
    $premiumType:String
    $industrialAllRisksProperties:[IndustrialAllRiskPropertyInput]
){
  createIndustrialAllRisks(input:{
    policyNo: $policyNo
    ...
    industrialAllRisksProperties:$industrialAllRisksProperties
  }){
    status
    message
    industrialAllRisks{
