            ...
            const data = [
                {
                    ...
                    premiumPaid: motorPolicy.calculateTotal.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","),
                    premiumBalance: motorPolicy.calculateBalance.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","),
                            ...
                            <Table.Body>
                                {motorPolicy.vehicles.map((vehicle, key) => (
                                    <Table.Row key={key}>
                                        ...
                                        <Table.Cell>{motorPolicy.calculateTotal.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</Table.Cell>
                                        <Table.Cell>{motorPolicy.calculateBalance.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</Table.Cell>
