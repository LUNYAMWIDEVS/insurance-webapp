...
export const CREATE_PLATE_GLASS=gql`
mutation createMoney (
    ...
    $premiumType:String
    $plateGlassProperties:[PlateGlassPropertyInput]
){
  createPlateGlass(input:{
    policyNo: $policyNo
    ...
    plateGlassProperties:$plateGlassProperties
  }){
    status
    message
    plateGlass{
