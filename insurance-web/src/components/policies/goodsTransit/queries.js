...
export const CREATE_GOODS_TRANSIT=gql`
mutation createGoodsTransit (
    $policyNo:String
    ...
    $premiumType:String
    $goodsTransitProperties:[GoodsTransitPropertyInput]
){
  createGoodsTransit(input:{
    policyNo: $policyNo
    ...
    goodsTransitProperties:$goodsTransitProperties
  }){
    status
    message
    goodsTransit{
