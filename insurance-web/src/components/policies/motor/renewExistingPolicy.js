...
export default function RenewExistingPolicy({ props }) {
    ...
    if (!values.fetched && motorPolicyData) {
      ...
      data.additionalBenefits.forEach((benefit, key) => {
        ...
        currentAddBen[key + 1] = {
          ...
          minimumAmount: fieldName
            ? fieldName.toUpperCase().includes(benefit.benefit)
            : ""
      ...
      if (!additionalFetched) {
        ...
        let additionalPrems = data.additionalPremiums.length - 1; // minus 1 to avoid counting stamp duty
        let newAddBen = [];
        let newAddPrem = [];
  ...
  if (renewed && values && policyOpts) {
    const insuranceClassOption = getPolicyOptionKey(
  ...
  const [renewPolicy, { loading }] = useCallback(
    useMutation(RENEW_MOTOR_POLICY, {
      update(_, result) {
        context.renewPolicy(result.data);
        let pol = result.data.createPolicyRenewal.policyRenewal;

        context.renewPolicy(result.data.createPolicyRenewal.policyRenewal);
        history.push({
              ...
              <Item>
                <Item.Content>
                  ...
                  {values.individualClient && (
                    <Item.Description>
                      ...
                      <span className="price">
                        {clientsData
                          ? `${clientsData.individualClient.firstName} ${clientsData.individualClient.lastName} ${clientsData.individualClient.surname}`
                          : ""}
                      </span>
                      <br />
                      <b>Email: </b>
                      ...
                      <span className="price">
                        {clientsData
                          ? clientsData.individualClient.idNumber
                          : ""}
                      </span>
                      <br />
                      <b>KRA Pin: </b>
                  ...
                  {values.corporateClient && (
                    <Item.Description>
                      <b>Name: </b>
                      <span className="price">corporateClient name...</span>
                      <br />
                      <b>Email: </b>
                      <span className="price">corporateClient email</span>
                      <br />
                      <b>Phone Number: </b>
                      <span className="price">corporateClient phoneNumber</span>
                      <br />
                      <b>kra Pin: </b>
                      <span className="price">corporateClient.kraPin</span>
                      <br />
                    </Item.Description>
                  )}
                </Item.Content>
              ...
              <Item>
                <Item.Content>
                  ...
                  <Item.Description>
                    ...
                    <span className="price">{values.insuranceCompany}</span>
                    <br />
                ...
                {values.policyDetailSet &&
                  values.policyDetailSet.map((fieldType, key) => (
                    <Item key={key}>
                      <Segment>
                        <Header as="h3">
                          {`${fieldType.name.name[0].toUpperCase()}${fieldType.name.name.slice(
                            1
                          )} Details`}
                        </Header>
                      </Segment>
        ...
        >
              ...
              <Item>
                <Item.Content>
                  ...
                  <Item.Description>
                    ...
                    <span className="price">
                      Ksh {formatAmount(values.minimumPremiumAmount)}{" "}
                    </span>
                    <br />
                    <span>
                      <b>Amount: </b>
                      <span className="price">
                        Ksh {formatAmount(calculated.netPremium)}{" "}
                      </span>
                      <br />
                    </span>
                  </Item.Description>
          ...
          {values.additionalBenefits && !!values.additionalBenefits.length && (
            <Grid.Column>
              ...
              <Item.Group>
                {Object.keys(addBenefits).map((key) => (
                    ...
                    <Item>
                      ...
                      <Item.Description>
                        ...
                        <span>
                          <b>Amount: </b>
                          <span className="price">
                            {`Ksh ${formatAmount(addBenefits[key].amount)}`}
                          </span>
                          <br />
                        </span>
                      </Item.Description>
          ...
          {!!values.additionalPremiums.length && (
            <Grid.Column>
              ...
              <Item.Group>
                {Object.keys(addPremiums).map((key) => (
                  <Item.Content key={key}>
                    <Item>
                      <Divider horizontal>.{key}.</Divider>
                      <Item.Description>
                        ...
                        <span>
                          ...
                          <span className="price">
                            ...
                            {addPremiums[key] && addPremiums[key].amount
                              ? formatAmount(addPremiums[key].amount)
                              : addPremiums[key].minimumAmount
                              ? formatAmount(addPremiums[key].minimumAmount)
                              : "0"}{" "}
                          </span>
                          <br />
                        </span>
          ...
          <div className="content-wrapper">
            <Header as="h3">
              ...
              <Header.Content>
                ...
                {">"} Renew Policy
                <Header.Subheader>
                  Fill this form to renew the policy
                </Header.Subheader>
              </Header.Content>
            </Header>
          </div>
          ...
          >
            ...
            <Form.Group widths="equal">
              ...
              >
                ...
                <Input fluid name="endDate" type="date" onChange={onChange} />
              </Form.Field>
            </Form.Group>
            <div>
              <br />
              <Divider horizontal>Existing Policy Details</Divider>
              ...
              {policyDetailSetCount.map((key) => (
                <Grid.Column key={key} width={8}>
                  ...
                  <div className="ui equal width grid">
                    <div className="column">
                      {policyFields &&
                        Object.keys(policyFields)
                          .slice(0, 4)
                          .map((key) => (
                            <div key={key} className="ui ">
                              <Form.Field inline>
                                <label>{key}</label>
                                <Input
                                  fluid
                                  name={policyFields[key]}
                                  id={key}
                    ...
                    <div className=" column">
                      {policyFields &&
                        Object.keys(policyFields).length > 8 &&
                        Object.keys(policyFields)
                          .slice(4, 8)
                          .map((key) => (
                            <div className="ui ">
                    ...
                    <div className="column">
                      {policyFields &&
                        Object.keys(policyFields).length > 8 &&
                        Object.keys(policyFields)
                          .slice(8, Object.keys(policyFields).length)
                          .map((key) => (
                            <div className="ui ">
                              <Form.Field inline>
                                <label>{key}</label>
            ...
            <Form.Group widths="equal">
              ...
              >
                ...
                <Input
                  ...
                  onChange={onChange}
                  defaultValue={
                    values.premiums ? values.premiums.basicPremium.amount : ""
                  }
                />
              </Form.Field>
              <Form.Field
