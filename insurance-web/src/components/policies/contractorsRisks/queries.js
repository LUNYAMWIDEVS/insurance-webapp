...
export const CREATE_CONTRACTORS_RISK=gql`
mutation createContractorsRisks (
    $policyNo:String
    ...
    $premiumType:String
    $contractorProperties:[ContractorsRiskPropertyInput]
){
createContractorsRisk(input:{
    policyNo: $policyNo
    ...
    contractorProperties:$contractorProperties
}){
    status
    message
    contractorsRisk{
