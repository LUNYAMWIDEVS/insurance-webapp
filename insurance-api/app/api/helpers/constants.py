...
MOTOR_POLICY_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date', 'policy_commission_rate',
                               'end_date', 'insurance_class', 'minimum_premium_amount',
...
PROFESSIONAL_INDEMNITY_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date',
                                         ...
                                         'transaction_type', 'premium_type', 'insurance_company']
INDIVIDUAL_MEDICAL_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date', 
                                     'end_date', 'premium_type', 'commission_rate', 'medical_insurance',
                                     'transaction_type', 'premium_type', 'insurance_company']
GROUP_MEDICAL_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date', 
                                'end_date', 'premium_type', 'commission_rate', 'medical_insurances',
                                'transaction_type', 'premium_type', 'insurance_company']
DOMESTIC_PACKAGE_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date', 
                                   'end_date', 'premium_type', 'commission_rate', 'package_details',
                                   'transaction_type', 'premium_type', 'insurance_company']
PERSONAL_ACC_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date', 
...
FIRE_POLICY_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date',
                              'end_date', 'premium_type', 'commission_rate', 'burglary_properties',
                              'transaction_type', 'premium_type', 'insurance_company']
COMPUTER_ELECTRONIC_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date',
                              'end_date', 'premium_type', 'commission_rate', 'computer_electronic_properties',
                              'transaction_type', 'premium_type', 'insurance_company']
CONSEQUENTIAL_LOSS_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date',
                              'end_date', 'premium_type', 'commission_rate', 'consequential_loss_properties',
                              'transaction_type', 'premium_type', 'insurance_company']

WIBA_POLICY_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date', 
                              'end_date', 'premium_type', 'commission_rate', 'no_of_staff',
                              'transaction_type', 'premium_type', 'insurance_company',
                              'estimate_annual_earning']
TRAVEL_REQUIRED_FIELD = ['policy_no', 'transaction_date', 'start_date', 
