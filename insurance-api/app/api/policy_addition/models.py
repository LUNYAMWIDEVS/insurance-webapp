...
class AdditionalBenefit(BaseModel):
    ...
    history = HistoricalRecords(
        table_name="history_policy_additions",
...
class PolicyAddition(BasePolicyModel):
    """
    Policy Addition Model
    """
    ...
    insurance_company = models.ForeignKey(
        ...
        related_name="policy_addition_insurance_co",
        null=True,
    )
    agency = models.ForeignKey(
        Agency,
        on_delete=models.CASCADE,
        related_name="policy_addition_agency",
        null=True,
    )
