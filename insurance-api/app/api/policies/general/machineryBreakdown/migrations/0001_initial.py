    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'history_machinery_breakdown',
        ...
        migrations.CreateModel(
            name='HistoricalMachineryBreakdown',
            fields=[
                ('deleted_at', models.DateTimeField(blank=True, db_index=True, default=None, editable=False, null=True)),
                ('id', models.CharField(db_index=True, max_length=255)),
                ('created_at', models.DateTimeField(blank=True, editable=False)),
            ...
            options={
                'verbose_name': 'historical machinery breakdown',
                'db_table': 'history_machine_breakdown_policy',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='machinerybreakdown_machinerybreakdown_related', to='agency.agency')),
                ('burglary_properties', models.ManyToManyField(to='machineryBreakdown.Property')),
                ('corporate_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='machinerybreakdown_machinerybreakdown_related', to='client.corporateclient')),
                ('individual_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='machinerybreakdown_machinerybreakdown_related', to='client.individualclient')),
                ('insurance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='machinerybreakdown_machinerybreakdown_related', to='insurancecompany.insurancecompany')),
            ],
            options={
