# Generated by Django 3.2 on 2021-08-26 09:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'history_consequential_property',
        ...
        migrations.CreateModel(
            name='HistoricalConsequentialLoss',
            fields=[
                ('deleted_at', models.DateTimeField(blank=True, db_index=True, default=None, editable=False, null=True)),
                ('id', models.CharField(db_index=True, max_length=255)),
                ('created_at', models.DateTimeField(blank=True, editable=False)),
            ...
            options={
                'verbose_name': 'historical consequential loss',
                'db_table': 'history_consequential_policy',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consequentialloss_consequentialloss_related', to='agency.agency')),
                ('burglary_properties', models.ManyToManyField(to='consequentialLoss.Property')),
                ('corporate_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='consequentialloss_consequentialloss_related', to='client.corporateclient')),
                ('individual_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='consequentialloss_consequentialloss_related', to='client.individualclient')),
                ('insurance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consequentialloss_consequentialloss_related', to='insurancecompany.insurancecompany')),
            ],
            options={
