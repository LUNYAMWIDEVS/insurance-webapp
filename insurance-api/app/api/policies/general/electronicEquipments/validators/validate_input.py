...
class ElectronicEquipmentValidations:
    '''Validations for the burglary policy'''

    def validate_electronic_equipment_data(self, kwargs, agency):
        '''
        ...
        input_data['electronic_equipment_properties'] = kwargs.get('electronic_equipment_properties', None)
        ...
        check_missing_fields(input_data['electronic_equipment_properties'],
                             FIRE_DETAILS_REQUIRED_FIELD)
        _ = [check_empty_fields(item) for item in input_data['electronic_equipment_properties']]

        self.validate_policy_no(input_data['policy_no'], agency)
        self.validate_choice_fields(input_data['transaction_type'],
                                    dict(ElectronicEquipment.TransactionType.choices),
                                    'transaction type')
        self.validate_choice_fields(input_data['premium_type'],
                                    dict(ElectronicEquipment.PremiumType.choices),
                                    'premium type')
    ...
    def validate_electronic_equipment_data_update(self, kwargs, agency):
        '''
    ...
    def validate_debit_note_no(self, debit_note_no, agency):
        ...
        '''
        if ElectronicEquipment.objects.all_with_deleted().filter(
