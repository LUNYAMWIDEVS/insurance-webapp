# Generated by Django 3.2 on 2021-08-26 09:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'history_industrialrisks_property',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical industrial all risk',
                'db_table': 'history_industrials_policy',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='industrialallrisks_industrialallrisk_related', to='agency.agency')),
                ('burglary_properties', models.ManyToManyField(to='industrialAllRisks.Property')),
                ('corporate_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='industrialallrisks_industrialallrisk_related', to='client.corporateclient')),
                ('individual_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='industrialallrisks_industrialallrisk_related', to='client.individualclient')),
                ('insurance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='industrialallrisks_industrialallrisk_related', to='insurancecompany.insurancecompany')),
            ],
            options={
