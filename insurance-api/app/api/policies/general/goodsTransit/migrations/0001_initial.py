    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'history_goodsTransit_properties',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical goods transit',
                'db_table': 'history_goodsTransit_policy',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goodstransit_goodstransit_related', to='agency.agency')),
                ('burglary_properties', models.ManyToManyField(to='goodsTransit.Property')),
                ('corporate_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='goodstransit_goodstransit_related', to='client.corporateclient')),
                ('individual_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='goodstransit_goodstransit_related', to='client.individualclient')),
                ('insurance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goodstransit_goodstransit_related', to='insurancecompany.insurancecompany')),
            ],
            options={
