# Generated by Django 3.2 on 2021-08-26 09:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'history_computer_electronics_property',
        ...
        migrations.CreateModel(
            name='HistoricalComputerElectronic',
            fields=[
                ('deleted_at', models.DateTimeField(blank=True, db_index=True, default=None, editable=False, null=True)),
                ('id', models.CharField(db_index=True, max_length=255)),
                ('created_at', models.DateTimeField(blank=True, editable=False)),
            ...
            options={
                'verbose_name': 'historical computer electronic',
                'db_table': 'history_computer_electronics',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='computerelectronics_computerelectronic_related', to='agency.agency')),
                ('burglary_properties', models.ManyToManyField(to='computerElectronics.Property')),
                ('corporate_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='computerelectronics_computerelectronic_related', to='client.corporateclient')),
                ('individual_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='computerelectronics_computerelectronic_related', to='client.individualclient')),
                ('insurance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='computerelectronics_computerelectronic_related', to='insurancecompany.insurancecompany')),
            ],
            options={
