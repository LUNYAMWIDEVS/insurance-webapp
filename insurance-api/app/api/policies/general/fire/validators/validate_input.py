...
class FirePolicyValidations:
    '''Validations for the fire policy'''

    def validate_fire_policy_data(self, kwargs, agency):
        '''
        Runs all the fire policy data validations in one function
        Args:
        ...
        input_data['properties'] = kwargs.get('properties', None)
    ...
    def validate_package_details_update(self, kwargs):
        '''
        Runs all the fire policy details data update validations in one function
        Args:
            kwargs (dict): request data
        Returns:
            input_data (dict): validated data
    ...
    def validate_fire_policy_data_update(self, kwargs, agency):
        '''
        Runs all the fire policy data update validations in one function
        Args:
            kwargs (dict): request data
        Returns:
            input_data (dict): validated data
