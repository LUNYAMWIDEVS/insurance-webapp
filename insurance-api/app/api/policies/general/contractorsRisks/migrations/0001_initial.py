    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'history_contractors_risks',
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical contractors risk',
                'db_table': 'history_contractors_policy',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contractorsrisks_contractorsrisk_related', to='agency.agency')),
                ('contractor_properties', models.ManyToManyField(to='contractorsRisks.Property')),
                ('corporate_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contractorsrisks_contractorsrisk_related', to='client.corporateclient')),
                ('individual_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contractorsrisks_contractorsrisk_related', to='client.individualclient')),
                ('insurance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contractorsrisks_contractorsrisk_related', to='insurancecompany.insurancecompany')),
            ],
            options={
