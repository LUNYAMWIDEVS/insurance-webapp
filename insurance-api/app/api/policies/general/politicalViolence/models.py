...
class Property(BaseModel):
    ...
    history = HistoricalRecords(table_name="history_political_violence_property",
...
class PoliticalViolence(BasePolicyModel):
    """
    Burglary Policy model
    """
    ...
    political_violence_properties = models.ManyToManyField(Property)
    agency = models.ForeignKey(Agency, on_delete=models.CASCADE,
                            related_name="%(app_label)s_%(class)s_related", null=False)

    history = HistoricalRecords(table_name="history_politicalViolence",
                                history_change_reason_field=ArrayField(models.CharField(
                                    max_length=250, blank=True,
                                    unique=False, null=True), blank=True,
                                    unique=False, null=True),
    ...
    def __str__(self):
        ...
        This string is used when a `BurglaryPolicy` is printed in the conEsole.
        """
