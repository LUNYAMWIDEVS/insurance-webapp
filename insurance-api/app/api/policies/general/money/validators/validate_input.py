...
class MoneyValidations:
    '''Validations for the burglary policy'''

    def validate_money_data(self, kwargs, agency):
        '''
        ...
        input_data['money_properties'] = kwargs.get('money_properties', None)
    ...
    def validate_money_data_update(self, kwargs, agency):
        '''
    ...
    def validate_debit_note_no(self, debit_note_no, agency):
        ...
        '''
        if Money.objects.all_with_deleted().filter(
