    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='individual_medical_insurance_agency', to='agency.agency')),
                ('individual_client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='individual_client_medical_insurance', to='client.individualclient')),
                ('insurance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='individual_client_medical_insurance_insurance_co', to='insurancecompany.insurancecompany')),
                ('medical_insurance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='individual_medical_insurance', to='medical.medicalinsurance')),
            ],
            options={
