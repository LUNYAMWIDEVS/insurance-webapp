...
from .mocks import (get_single_individual_medical_query,
...
class TestGetListMotorPolicy(IndividualMedicalInsBaseTest):
    ...
    def test_get_individual_medical_succeeds(self):
        """
        ...
        response = self.client.execute(
            get_single_individual_medical_query,
    ...
    def test_list_prof_indemnities_succeeds(self):
        ...
        """
        self.create_individual_medical_policy()
    ...
    def test_get_individual_medical_options_succeeds(self):
        """
